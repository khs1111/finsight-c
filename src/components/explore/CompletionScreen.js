...
>
  <ellipse cx="118.852" cy="126.146" rx="75.7939" ry="65.175" fill="#272727" />
  <path
...
>
  ...
  <div
    style={{
      ...
      lineHeight: "14px",
      color: "#474747",
      boxShadow: "0px 0px 12px rgba(0, 0, 0, 0.16)", // 상단 말풍선과 같은 그림자
    }}
  >
  ...
  <div
    style={{
      ...
      background: "#FFFFFF", // ✅ 흰색으로 변경
      clipPath: "polygon(50% 100%, 0 0, 100% 0)",
      boxShadow: "0px 0px 12px rgba(0, 0, 0, 0.16)", // 꼬리도 그림자 포함
    }}
  />
</div>
      ...
      >
        <button
          ...
          style={{
            ...
            background:
              score === 0
                ? "linear-gradient(104.45deg, #FF5959 -6.51%, #D81B60 105.13%)"
